...
#       self.screen.fill(BLACK)
#       self.all_sprites.draw(self.screen)
#       self.draw_text(self.screen, "Health:"+str(self.player.health), 20, WHITE, 30, 20) 
#       self.draw_text(self.screen, "Score:"+str(self.player.score), 20, WHITE, 30, 40) 
#       self.draw_text(self.screen, "Time:"+ str(self.time), 20, WHITE, 30, 60)
#       pg.display.flip()
